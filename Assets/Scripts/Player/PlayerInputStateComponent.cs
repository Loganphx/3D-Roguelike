...
namespace ECS.Movement.Services
{
    ...
    public class PlayerInputComponent : IComponent<PlayerInputState>
    {
      ...
      public void OnUpdate()
      {
        ...
        input.JumpPressed = input.JumpPressed || _keyboard.spaceKey.wasPressedThisFrame;
      ...
      public void OnFixedUpdate()
      {
        ...
        input.JumpHeld = _keyboard.spaceKey.isPressed;
  ...
  public struct GameplayInput /* : ISerializable, IDeserializable<GameplayInput>*/
  {
    ...
    {
      get => Actions.IsSet(GameplayInputAction.Jump_Pressed);
      set => Actions.Set(GameplayInputAction.Jump_Pressed, value);
    }
    public bool JumpHeld
    {
      get => Actions.IsSet(GameplayInputAction.Jump_Held);
      set => Actions.Set(GameplayInputAction.Jump_Held, value);
    }
