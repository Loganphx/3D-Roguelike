...
public class Player : MonoBehaviour, IPlayer, IDamagable
{
  ...
  private void Start()
  {
    ...
    _playerUIInventoryComponent = new PlayerUIInventoryComponent(canvas.Find("Inventory").Find("Slots"));
  }
  ...
  public void Update()
  {
    ...
    _playerUIHUDComponent.OnUpdate(ref _playerHealthComponent._healthState, ref _playerStaminaComponent._staminaState,
  ...
  public void AddItem(Item item)
  {
    ...
    // Gold += item.GoldValue;
    _playerInventoryComponent.AddItem(item.itemType, 1);
  }
